<#
    :Title: Server Hardening Script - AMD Servers with Hyper-V installed
    ...
    :Description 
                 Script to perform server hardening settings on a new on-prem or azure Windows Servers.  If this is not a Hyper-V host, please 
                 download the script in the repository for your processor type without Hyper-V.
